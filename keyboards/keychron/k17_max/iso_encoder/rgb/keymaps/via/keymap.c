...
#define TAB_TAP_HOLD LT(NAVIGATION, KC_TAB)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT_105_iso(
        ...
        TAB_TAP_HOLD,         KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,                 KC_PGDN,  KC_P7,    KC_P8,    KC_P9,    KC_PPLS,
